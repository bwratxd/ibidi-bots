...
module.exports = async (member) => {
  ...
  if (invite === member.guild.vanityURLCode) channel.send(`<a:1984simarik:829013311948455956> ${member} katıldı! **Davet eden:** Sunucu Özel URL`);
  ...
  if (Date.now() - member.user.createdTimestamp <= 1000 * 60 * 60 * 24 * 7) {
    ...
    channel.send(`<a:1984simarik:829013311948455956> ${member} sunucumuza katıldı. ${invite.inviter.tag} tarafından davet edildi. (**${total}** davet)`);
  } else {
