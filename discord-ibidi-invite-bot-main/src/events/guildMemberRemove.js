...
module.exports = async (member) => {
  ...
  if (!inviteMemberData) {
    channel.send(`<a:1984simarik:829013311948455956> \`${member.user.tag}\` sunucumuzdan ayrıldı ama kim tarafından davet edildiğini bulamadım.`);
  } else {
    ...
    channel.send(`<a:1984simarik:829013311948455956> \`${member.user.tag}\` sunucumuzdan ayrıldı. ${inviter.tag} tarafından davet edilmişti. (**${total}** davet)`);
  }
};
